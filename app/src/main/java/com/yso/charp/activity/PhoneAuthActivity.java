...
public class PhoneAuthActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    private ViewGroup mSendNameViews;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mSendNameViews = (ViewGroup) findViewById(R.id.send_user_name_field);
        ...
        mNameField = (EditText) findViewById(R.id.field_user_name);

        mStartButton = (Button) findViewById(R.id.button_start_verification);
        mVerifyButton = (Button) findViewById(R.id.button_verify_phone);
        mResendButton = (Button) findViewById(R.id.button_resend);
        mSignOutButton = (Button) findViewById(R.id.sign_out_button);
        mSendNameButton = (Button) findViewById(R.id.button_send_name);
